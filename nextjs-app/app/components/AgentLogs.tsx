    ...
    <div className="space-y-4 h-full flex flex-col">
      <div className="flex items-center justify-between pb-4 border-b border-[var(--border)]">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-semibold text-[var(--text)]">System Console</h2>
        ...
        <div className="flex items-center gap-4 px-3 py-1.5 bg-[var(--bg-subtle)] border border-[var(--border)] rounded-lg">
          <div className="flex flex-col items-center">
            <span className="text-[10px] text-text-dim">Steps</span>
            <span className="text-sm font-mono text-[var(--text)]">{logs.length}</span>
          </div>
        ...
        <AnimatePresence>
          {logs.map((log, index) => (
            <motion.div
              ...
              className={`p-4 rounded-xl border transition-all group overflow-hidden ${log.role === 'react_worker' ? 'bg-purple-500/[0.03] border-purple-500/15' : 'bg-[var(--bg-card)] border-[var(--border)] hover:border-primary/20'}`}
            >
              <div className="flex flex-col space-y-3">
                <div className="flex items-center justify-between gap-2">
                  <div className="flex items-center gap-2 min-w-0">
                    ...
                    <span className="text-xs font-medium text-[var(--text)] truncate">{log.task}</span>
                  </div>
                ...
                <div className="flex items-center gap-2 px-2.5 py-1 bg-[var(--bg-subtle)] border border-[var(--border)] rounded-md w-fit">
                ...
                {log.result_preview && (
                  <pre className="p-3 bg-[var(--bg-card)] rounded-lg border border-[var(--border)] text-xs text-text-secondary font-mono leading-relaxed whitespace-pre-wrap">
                    {log.result_preview}
                  </pre>
                )}
              </div>
